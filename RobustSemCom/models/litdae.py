...
class LitDAE(pl.LightningModule):
    ...
    def __init__(self, model, cfg, optimizer, criterion, lr_scheduler, device="GPU") -> None:
        """
        Initialize the DAE.
        ...
        self.cfg = cfg
        self.loss = criterion
        self.epsilon = cfg.get('epsilon', 0.1)  # Ensure epsilon is defined in your cfg
        #self.device = device
    ...
    def training_step(
        ...
        loss = self.loss(self.model, img, epsilon=self.epsilon, device=self.cfg.device)
